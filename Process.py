# Process class in scheduling unit of operating system (OS)
class Process:
    def __init__(self, process_id, arrival_time, CPU_burst_time_1, IO_burst_time, CPU_burst_time_2):
    ...
    def print_process(process):
        print(f"Process ID: {process.process_id} | Arrival Time: {process.arrival_time} | CPU Burst Time 1: {process.CPU_burst_time_1} | IO Burst Time: {process.IO_burst_time} | CPU Burst Time 2: {process.CPU_burst_time_2} | Response Time: {process.response_time} | Turn Around Time: {process.turn_around_time} | Waiting Time: {process.waiting_time} | Termination Time: {process.termination_time}")
